...
export class PeerLifecycleError extends EarthstarError {
    constructor(message?: string) {
        super(message || 'a Peer instance was used in the wrong part of its lifecycle.');
        this.name = 'PeerLifecycleError';
    }
}
